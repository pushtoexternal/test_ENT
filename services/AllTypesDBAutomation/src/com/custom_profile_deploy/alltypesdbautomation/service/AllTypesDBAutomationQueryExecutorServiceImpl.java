...
@Service
public class AllTypesDBAutomationQueryExecutorServiceImpl implements AllTypesDBAutomationQueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(AllTypesDBAutomationQueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("AllTypesDBAutomationWMQueryExecutor")
